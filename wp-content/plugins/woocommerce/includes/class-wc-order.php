...
class WC_Order extends WC_Abstract_Order {
	...
	*/
	...
	public function get_billing_first_name( $context = 'view' ) {
		return $this->get_address_prop( 'name', 'billing', $context );
	}
	...
	public function get_shipping_first_name( $context = 'view' ) {
		return $this->get_address_prop( 'name', 'shipping', $context );
	}
	...
	public function get_shipping_address_map_url() {
		...
		unset( $address['name'], $address['last_name'], $address['company'] );
	...
	*/
	...
	public function set_billing_first_name( $value ) {
		$this->set_address_prop( 'name', 'billing', $value );
	}
	...
	public function set_shipping_first_name( $value ) {
		$this->set_address_prop( 'name', 'shipping', $value );
	}
