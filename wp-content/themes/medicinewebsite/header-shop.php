...
<head>
    ...
    <link href="<?php bloginfo('stylesheet_directory'); ?>/assets/css/kenburn.css" rel="stylesheet"/>
    ...
    <!-- Custom css -->
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_directory'); ?>/assets/css/custom-shop.css" />
...
<div id="page" class="site" style="display: none;">
    ...
    <div id="top-bar">
        ...
        <div class="container custom-top-bar-container clearfix">
                ...
                <div id="top-social">
                    <ul>
                        ...
                        <li id="header-custom-si-call-text">
                            <a href="https://www.skf-oncology.com/" class="si-call custom-si-call cutom-tag-a-class-for-news">
                                      <span class="ts-icon">
                                ...
                                <span class="ts-text">ESKAYEF ONCOLOGY</span>
                            </a>
                        </li>
                            ...
                            <a href="#" class="cutom-tag-a-class-for-hr">
                              <span class="ts-icon">
                               <i class="custom-icon-for-header"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/custom-images/FOR-NEW-HEADER/career.png"></i>
                                ...
                                <span class="ts-text">Career and HR</span>
                            </a>
                        </li>
    ...
    <header id="header" class="transparent-header floating-header" data-sticky-class="not-dark">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                <!-- Logo ============================================= -->
                <div id="logo">
                    <a href="https://psionic.io/eskayef/" class="standard-logo"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/custom-images/logo/skf-logo-3.png" alt="Eskayef Logo"></a>
                    <a href="https://psionic.io/eskayef/" class="retina-logo"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/custom-images/logo/skf-logo-3.png" alt="Eskayef Logo"></a>
                </div>
                ...
                <nav id="primary-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="https://psionic.io/eskayef/products"><div>Products</div></a>

                        </li>
                        <li><a href="https://psionic.io/eskayef/facilities"><div>Facilities</div></a>
                            <ul>
                                <li><a href="https://psionic.io/eskayef/facilities#manufacturing-line"><div>Manufacturing Line</div></a>
                                    <ul>
                                        <li><a href="https://psionic.io/eskayef/facilities#general-unit"><div>General Unit</div></a></li>
                                        <li><a href="https://psionic.io/eskayef/facilities#cephalosphorin-unit"><div>Cephalosporin Unit</div></a></li>
                                    </ul>
                                </li>
                        ...
                        <li><a href="https://psionic.io/eskayef/global-presence"><div>Global Presence</div></a>
                        </li>

                        <!-- <li><a href="https://psionic.io/eskayef/news-events"><div>News & Events</div></a></li> -->

                        <li><a href="https://psionic.io/eskayef/contact"><div>Contact</div></a></li>
                        <li class="custom-header-option-for-mobile-only">

                            <div class="header-option-holder-div-for-mobile">
                                <a href="https://psionic.io/eskayef/news-and-events"><i><img class="news-blue-logo-mobile" src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/custom-images/FOR-NEW-HEADER/news-blue-logo-mobile.png"></i></a>
                                <a href="#"><i><img class="career-logo-blue-mobile" src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/custom-images/FOR-NEW-HEADER/career-logo-blue-mobile.png"></i></a>
                                <a href="#"><i><img class="facebook-blue-mobile" src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/custom-images/FOR-NEW-HEADER/facebook-blue-mobile.png"></i></a>
                                <a href="#"><i><img class="youtube-blue-mobile" src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/custom-images/FOR-NEW-HEADER/youtube-blue-mobile.png"></i></a>
                            </div>
